            ...
            <ScrapPageCard variant="cream" rotation={0}>
              ...
              <form className="contact-form" onSubmit={handleSubmit}>
                ...
                <div className="form-group">
                  ...
                  <textarea
                    ...
                    name="message"
                    className="input-field"
                    placeholder="Hello Prisha, I'd like to..."
              ...
              <div className="social-section">
                ...
                <div className="social-links">
                  <a href="mailto:prisha@example.com" className="social-link link-email" aria-label="Email">
                    <MailIcon />
                  </a>
                  <a href="https://github.com/prisha" target="_blank" rel="noopener noreferrer" className="social-link link-github" aria-label="GitHub">
                    <GitHubIcon />
                  </a>
