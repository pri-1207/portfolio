export default function Footer() {
    ...
    return (
        <footer className="py-12 px-6 border-t border-pink-100">
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    <a href="#" className="font-editorial text-2xl font-semibold text-text-primary">
                        Prisha<span className="text-accent-rose">.</span>
                    </a>
                ...
                <div className="mt-8 pt-8 border-t border-pink-50 text-center">
                    <p className="text-xs text-text-muted">
                        © {currentYear} Prisha Gupta. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
